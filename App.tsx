...
import { Trophy, RefreshCw, AlertTriangle, ChevronsRight } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-f1-black text-white font-sans selection:bg-f1-red selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-6">
               <div className="hidden md:flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-gray-500">
              ...
              {status === LoadingState.SUCCESS && (
                <button 
                  onClick={loadData}
                  className="group flex items-center gap-2 px-4 py-1.5 border border-gray-700 hover:border-f1-red rounded-sm transition-all"
                  title="Refresh Data"
                >
                  <RefreshCw className="w-4 h-4 text-gray-400 group-hover:text-f1-red group-hover:rotate-180 transition-all duration-500" />
                  <span className="text-xs font-bold uppercase text-gray-400 group-hover:text-white">Refresh</span>
                </button>
              )}
            </div>
          </div>
